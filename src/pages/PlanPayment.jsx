        ...
        <div className="container-wide grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="light-card mt-8 rounded-lg p-5">
              ...
              <div className="mt-5 space-y-3 text-sm text-[#101312]/68">
                <div className="flex items-start justify-between gap-4">
                  <span>Plan</span>
                  <span className="text-right font-semibold text-[#101312]">{selectedPlan.name}</span>
                </div>
                <div className="flex items-start justify-between gap-4">
                  <span>Package</span>
                  <span className="text-right font-semibold text-[#101312]">
          ...
          <form onSubmit={handleSubmit} className="light-card rounded-lg p-5 sm:p-7">
            <div className="flex items-center gap-3">
              <CreditCard size={22} className="text-[#16837a]" />
            ...
            {status && (
              <div className="mt-5 rounded-lg border border-[#16837a]/20 bg-[#16837a]/10 px-4 py-3 text-sm font-medium text-[#0f5f58]">
                {status}
              </div>
            )}

            {!isFree && (
              <div className="mt-6 rounded-lg border border-[#101312]/10 bg-[#101312] p-5 text-white">
                <p className="text-sm text-white/58">Pay to UPI ID</p>
                <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <p className="break-all text-2xl font-semibold">{UPI_ID}</p>
                  <button
                    type="button"
                    onClick={copyUpi}
            ...
            {isFree ? (
              ...
              <label className="mt-6 flex cursor-pointer flex-col items-center justify-center rounded-lg border border-dashed border-[#101312]/20 bg-[#f7f3ea] px-4 py-8 text-center transition hover:border-[#101312]/40">
                <FileImage size={28} className="text-[#e05f2f]" />
                <span className="mt-3 text-sm font-semibold text-[#101312]">
